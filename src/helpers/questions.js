export const questions = [
  ...
  },
  {
    ...
    },
   {
    ...
    variants: ["Выключить монитор", "Написать на ЮК Буран", "Нажать кнопку Закрыть", "Все варианты верны"],
    correct: 2
    },
    {
    title: "Что влияет на скорость работы Бурана?",
    variants: ["День недели", "Скорость интернета", "Уровень знаний пользователя", "Алексей Уланов"],
    correct: 1
  },
       {
    title: "Кто из них нормальный тип?",
    variants: ["путин", "лукашенко", "медведев", "Все они уроды"],
    correct: 3
  },
];